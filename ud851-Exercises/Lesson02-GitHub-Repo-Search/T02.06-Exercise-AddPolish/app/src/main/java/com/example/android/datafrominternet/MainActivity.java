...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mProgressBarvar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErorMessageDisplay = (TextView)findViewById(R.id.tv_error_message_display);

        // TODO (25) Get a reference to the ProgressBar using findViewById
        mProgressBarvar = (ProgressBar) findViewById(R.id.pb_loading_indicator);
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressBarvar.setVisibility(View.VISIBLE);
            mSearchResultsTextView.setVisibility(View.INVISIBLE);
            mErorMessageDisplay.setVisibility(View.INVISIBLE);
        }
        ...
        protected void onPostExecute(String githubSearchResults) {
            ...
            mProgressBarvar.setVisibility(View.INVISIBLE);
